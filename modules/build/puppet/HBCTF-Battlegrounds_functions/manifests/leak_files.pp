define HBCTF-Battlegrounds_functions::leak_files($leaked_filenames=[], $storage_directory, $strings_to_leak=[], $images_to_leak=[], $owner = 'root', $group = 'root', $mode = '0777', $leaked_from) {
  ...
  $string_leak_pairs.each |$counter, $leak_pair| {
      ...
      unless $leaked_filename == undef {
        ...
        HBCTF-Battlegrounds_functions::leak_file { $leaked_file_resource:
