class onlinestore::install {
  ...
  $db_flag = $HBCTF-Battlegrounds_parameters['strings_to_leak'][0]
  $admin_flag = $HBCTF-Battlegrounds_parameters['strings_to_leak'][1]
  $root_file_flag = $HBCTF-Battlegrounds_parameters['strings_to_leak'][2]
  $black_market_flag = $HBCTF-Battlegrounds_parameters['strings_to_leak'][3]

  $docroot = '/var/www'
  $db_username = 'csecvm'
  $db_password = $HBCTF-Battlegrounds_parameters['db_password'][0]
