...
# Displays HBCTF-Battlegrounds usage data
def usage
  Print.std "Usage:
   #{$0} [--options] <command>
...
def default_project_dir
  "#{PROJECTS_DIR}/HBCTF-Battlegrounds#{Time.new.strftime("%Y%m%d_%H%M")}"
end
...
Print.std '~'*47
Print.std 'HBCTF-Battlegrounds - Creates virtualised security scenarios'
